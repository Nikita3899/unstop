...
const ModalContainer = (
  ...
  return (
    <div className={style['drawer-container']}>
        ...
        margin: isMobileView ? '50px 667px 0px' :'50px 520px 128px 520px',
        width: isMobileView ?'25vw':'42vw',
        display: 'flex',
        height:'80vh',
        alignItems: 'center',
      ...
      >
        ...
        <img src={isMobileView ? cutRed : cut} alt='' onClick={()=>setIsShowModal(false)} className={style['red-cut']}/>
        </div>
        <div>
